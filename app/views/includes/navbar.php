<nav class="navbar navbar-default navbar-fixed-top navbar-custom" role="navigation">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo APP_URL;?>"><img src="<?php echo APP_URL;?>public/images/1.jpg"  width="48" height="48" style="float:left;margin-top: -14px; margin-left: -10px;"> HTU Store</a>
    </div>
